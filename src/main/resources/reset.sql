...
INSERT INTO `menu` VALUES ('400', '美团订单管理', '-', 'icon-sys', '0', 1);
INSERT INTO `menu` VALUES ('401', '美团订单页', 'casual.html', 'icon-log', '400', 0);
INSERT INTO `menu` VALUES ('402', '美团拉数据店铺', 'mtsping.html', 'icon-log', '400', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', '我是系统管理员', '3ef7164d1f6167cb9f2658c07d3c2f0a', '2019-04-04');
INSERT INTO `user` VALUES (2, 'manager', '我是经理', 'bb2ec153e560c6cb94a35b370eb7a07b', '2019-05-02');
INSERT INTO `user` VALUES (3, 'salemanager', '我是销售主管', '40fd0e9ba2e7241cb04c49a7663464c1', '2019-05-06');
INSERT INTO `user` VALUES (4, 'saler', '我是销售员', '846366204c8cc44abdedf5f201da0b00', '2019-05-20');
INSERT INTO `user` VALUES (5, 'casual', '我是临时工', '130131080b677e15df326f8114c426a3', '2019-05-04');
